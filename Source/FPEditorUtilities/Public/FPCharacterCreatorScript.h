...
#include "FPCharacterCreatorScript.generated.h"
...
class FPEDITORUTILITIES_API UFPCharacterCreatorScript : public UEditorUtilityObject
{
	GENERATED_BODY()

	UFPCharacterCreatorScript();
